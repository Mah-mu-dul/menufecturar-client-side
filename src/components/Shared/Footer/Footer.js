...
const Footer = () => {
  return (
    <div>
      <footer class="footer p-10 bg-accent text-neutral-content pb-20">
        <div>
          <svg
            width="50"
            height="50"
          ...
          <p>Eletro Industries Ltd.Providing reliable tech since 1992</p>
        </div>
        <div>
          <span class="footer-title mx-auto">Social connention</span>
